package com.amigos.amigoscode.service;

import com.amigos.amigoscode.dao.StudentRepository;
...
public class StudentService {
    ...
    public void updateStudent(Long studentId,
        ...
        && email.length() > 0 && !Objects.equals(student.getEmail(), email)) {
            Optional<Student> getStudentByEmail = studentRepository.findStudentByEmail(email);
